export default () => <section className="fullscreen whatido">
    <div className="container">
        <div className="content">
            <section data-scroll data-scroll-speed="2">
                <header>
                    Accompagnement
                    <div className="bg" data-scroll data-scroll-speed="3"/>
                </header>
            ...
            <p>
                Je passe beaucoup de temps à étudier comment le Web et le
                marketing affectent nos choix. Et beaucoup de temps à programmer.
            </p>
        </div>
    </div>
    <div className="bg">
