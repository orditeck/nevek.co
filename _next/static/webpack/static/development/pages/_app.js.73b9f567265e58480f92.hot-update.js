...
function (_App) {
  ...
  function Nevek() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "updateFooter", function () {
      document.querySelector('body').style.paddingBottom = document.querySelector('footer#site-footer').offsetHeight + 'px';
    });
...
//# sourceMappingURL=_app.js.73b9f567265e58480f92.hot-update.js.map