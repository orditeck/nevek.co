...
function (_App) {
  ...
  function Nevek() {
    ...
    _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
      var main, footer, footerHeight, windowHeight, safetyMargin;
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              main = document.querySelector('div#__next');
              footer = document.querySelector('footer#site-footer .container');
...
//# sourceMappingURL=_app.js.5abfe2e58ea07bbcca31.hot-update.js.map