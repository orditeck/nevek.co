...
function (_App) {
  ...
  function Nevek() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "updateFooter",
    /*#__PURE__*/
    _asyncToGenerator(
    /*#__PURE__*/
    _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
      var main, footer, footerContainerHeight, windowHeight, safetyMargin;
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              main = document.querySelector('div#__next');
              footer = document.querySelector('footer#site-footer');
              footerContainerHeight = footer.querySelector('.container').offsetHeight;
              windowHeight = document.documentElement.clientHeight;
              safetyMargin = 50;

              if (footerContainerHeight + safetyMargin > windowHeight) {
...
//# sourceMappingURL=_app.js.209ee3703eac008a4580.hot-update.js.map