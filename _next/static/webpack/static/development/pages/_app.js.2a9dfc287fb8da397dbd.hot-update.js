...
function (_App) {
  ...
  function Nevek() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "updateFooter", function () {
      console.log(document.querySelector('footer#site-footer').clientHeight);
      document.querySelector('body').style.paddingBottom = document.querySelector('footer#site-footer').clientHeight;
    });
...
//# sourceMappingURL=_app.js.2a9dfc287fb8da397dbd.hot-update.js.map