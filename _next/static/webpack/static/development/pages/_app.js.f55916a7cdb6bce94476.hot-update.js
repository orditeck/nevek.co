...
function (_App) {
  ...
  function Nevek() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "updateFooter", function () {
      var main = document.querySelector('div#__next');
      ...
      footer.classList.add('fixed'); //main.style.paddingBottom = footerHeight + 'px';
    });
...
//# sourceMappingURL=_app.js.f55916a7cdb6bce94476.hot-update.js.map