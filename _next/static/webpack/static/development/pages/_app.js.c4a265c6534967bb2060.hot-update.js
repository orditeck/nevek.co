...
function (_App) {
  ...
  function Nevek() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "updateFooter", function () {
      var footerHeight = document.querySelector('footer#site-footer').offsetHeight;
      var windowHeight = document.documentElement.clientHeight;
      var safetyMargin = 50;

      if (footerHeight + safetyMargin > windowHeight) {
        document.querySelector('#__next').style.paddingBottom = document.querySelector('footer#site-footer').offsetHeight + 'px';
      } else {
        document.querySelector('#__next').style.paddingBottom = document.querySelector('footer#site-footer').offsetHeight + 'px';
      }
    });
...
//# sourceMappingURL=_app.js.c4a265c6534967bb2060.hot-update.js.map