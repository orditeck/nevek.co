...
function (_App) {
  ...
  function Nevek() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "updateFooter", function () {
      ...
      var windowHeight = document.querySelector('#__next').style.paddingBottom = document.querySelector('footer#site-footer').offsetHeight + 'px';
    });
...
//# sourceMappingURL=_app.js.1b486e64836820988e47.hot-update.js.map